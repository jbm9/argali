# rules.mk from libopencm3's examples directory.
#
...
%.flash: %.elf
	@printf "  FLASH\t$<\n"
ifeq (,$(OOCD_FILE))
	$(Q)(echo "halt; program $(realpath $(*).elf) verify reset" | nc -N -4 localhost $(OOCD_PORT) 2>/dev/null) || echo "Failed to program via telnet"
#
...
#		$(NULL)
	...
	$(Q)(echo "halt; program $(realpath $(*).elf) verify reset" | nc -N -4 localhost $(OOCD_PORT) 2>/dev/null) || \
		$(OOCD) -f $(OOCD_FILE) \
		-c "program $(realpath $(*).elf) verify reset exit" \
		$(NULL)
endif
